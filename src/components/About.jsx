        ...
        <div className="about">
                    ...
                    <div className="ref-image">
                        ...
                        <div className="main-icon-box">
                            <AboutIcon imageSrc = {eye} headName = "SEEING OPPURTUNITIES" text = "lobal organization, Enactus Thapar is guided by a set of core values "/>
                            <AboutIcon imageSrc = {action} headName = "TAKING ACTION" text = "obal organization, Enactus Thapar is guided by a set of core values and " />
                            <AboutIcon imageSrc = {process} headName = "ENABLING PROCESS" text = "obal organization, Enactus Thapar is guided by a set of core val"/>
                            <AboutIcon imageSrc = {process} headName = "ENABLING PROCESS" text = "obal organization, Enactus Thapar is guided by a set of core values "/>
                        </div>
                    </div>
