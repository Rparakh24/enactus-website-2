    ...
    >
      ...
      <div className="journey-text-box">
        <p className="journey-text">
          ...
          sollicitudin tempor id eu nisl. Sed vulputate odio ut enim blandit
          volutpat maecenas volutpat. Erat imperdiet sed euismod nisi porta
          lorem. Lacus viverra vitae congue eu consequat ac felis donec.
          Adipiscing elit ut aliquam purus. Eu feugiat pretium nibh ipsum. Lacus
